...
def create_app(database_name, testing=False):
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = (
        os.environ.get('DATABASE_ULR', f'postgresql:///{database_name}'))
    ...
    def profile():
        ...
        form = UserEditForm(username=g.user.username, email=g.user.email, image_url=g.user.image_url, header_image_url=g.user.header_image_url, bio=g.user.bio)
